...
data_args = dict(
    ...
    test=None,
    # ,
    multitest={"ImageNet1k_test100": {'cfg': dataset, 'compute_metric': dict(type='ImageNetTest100Metrics', filename=r'/home/oshita/vlm/Link-Context-Learning/docs/test100_pairs.jsonl')}},
    compute_metric=None,
