...
class cifar_loader():
    def __init__(self,root,batch_size):
        ...
        self.train_dataset=cifar_dataset(self.root,'train',test_transform,num_samples=50000)
        self.valid_dataset=cifar_dataset(self.root,'valid',self.test_transform,num_samples=50000)
        self.test_dataset=cifar_dataset(self.root,'test',test_transform,num_samples=50000)
...
if __name__ == '__main__':
    loader=cifar_loader('/home/oshita/cleansing/data/cifar-10',256)
