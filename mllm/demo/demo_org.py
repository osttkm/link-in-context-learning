...
parser.add_argument('--model_path', default=r'/home/oshita/vlm/Link-Context-Learning/shikra2VI_SHUFFLE_10/checkpoint-50')
# parser.add_argument('--model_path', default=r'/home/oshita/vlm/Link-Context-Learning')
parser.add_argument('--server_name', default=SLURM_ENV.get('SLURM_JOB_NODELIST', None))
parser.add_argument('--server_port', type=int, default=20500)
            ...
            with gr.Row(variant='compact'):
                with gr.Column():
                    with gr.Group():
                        ...
                        pos_q = gr.Textbox(placeholder="What is in the image?",label="Question(Fixed)",interactive=True)
                ...
                with gr.Column():
                    with gr.Group():
                        ...
                        neg_q = gr.Textbox(placeholder="What is in the image?",label="Question(Fixed)",interactive=True)
