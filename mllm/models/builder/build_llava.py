...
def load_pretrained_llava(model_args, training_args):

    import logging

    logger = logging.getLogger(__name__)    
    model = LlavaLlamaForCausalLM.from_pretrained(pretrained_model_name_or_path=model_args.model_name_or_path
                                                  ,cache_dir=model_args.cache_dir,from_tf=False)
